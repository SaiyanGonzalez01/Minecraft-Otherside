...
public class RecipesWeapons {
	...
	private Object[][] recipeItems = new Object[][]{{Block.planks, Item.ingotCopper, Item.ingotIron, Item.diamond, Item.ingotGold}, {Item.swordWood, Item.swordCopper, Item.swordSteel, Item.swordDiamond, Item.swordGold}};
