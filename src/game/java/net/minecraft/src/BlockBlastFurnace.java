...
public class BlockBlastFurnace extends BlockContainer {
	...
	public boolean blockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5) {
		TileEntityBlastFurnace var6 = (TileEntityBlastFurnace)var1.getBlockTileEntity(var2, var3, var4);
		var5.displayGUIBlastFurnace(var6);
		return true;
	}
	...
	public static void updateFurnaceBlockState(boolean var0, World var1, int var2, int var3, int var4) {
		...
		if(var0) {
			var1.setBlockWithNotify(var2, var3, var4, Block.blastOvenActive.blockID);
		} else {
			var1.setBlockWithNotify(var2, var3, var4, Block.blastOvenIdle.blockID);
		}
