...
public class TileEntityBlastFurnace extends TileEntity implements IInventory {
	...
	private int getSmeltingResult(int var1) {
		return var1 == Block.oreIron.blockID ? Item.ingotIron.shiftedIndex : (var1 == Block.oreGold.blockID ? Item.ingotGold.shiftedIndex : (var1 == Block.sand.blockID ? Block.glass.blockID : (var1 == Block.cobblestone.blockID ? Block.stone.blockID : -1)));
	}
