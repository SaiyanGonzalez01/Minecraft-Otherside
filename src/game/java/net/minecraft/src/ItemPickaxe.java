...
public class ItemPickaxe extends ItemTool {
	...
	public boolean canHarvestBlock(Block var1) {
		return var1 == Block.obsidian ? this.getHarvestLevel == 3 : (var1 != Block.blockDiamond && var1 != Block.oreDiamond ? (var1 != Block.blockGold && var1 != Block.oreGold ? (var1 != Block.blockSteel && var1 != Block.oreIron ? (var1 != Block.blockCopper && var1 != Block.oreCopper ? (var1.blockMaterial == Material.rock ? true : var1.blockMaterial == Material.iron) : this.getHarvestLevel >= 3) : this.getHarvestLevel >= 2) : this.getHarvestLevel >= 1) : this.getHarvestLevel >= 0);
	}
}
