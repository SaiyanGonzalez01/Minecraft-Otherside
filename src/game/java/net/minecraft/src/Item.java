...
public class Item {
	...
	public static Item swordDiamond = (new ItemSword(20, 4)).setIconIndex(67);
	public static Item shovelDiamond = (new ItemSpade(21, 4)).setIconIndex(83);
	public static Item pickaxeDiamond = (new ItemPickaxe(22, 4)).setIconIndex(99);
	public static Item axeDiamond = (new ItemAxe(23, 4)).setIconIndex(115);
	...
	public static Item swordGold = (new ItemSword(27, 3)).setIconIndex(68);
	public static Item shovelGold = (new ItemSpade(28, 3)).setIconIndex(84);
	public static Item pickaxeGold = (new ItemPickaxe(29, 3)).setIconIndex(100);
	public static Item axeGold = (new ItemAxe(30, 3)).setIconIndex(116);
	...
	public static Item hoeDiamond = (new ItemHoe(37, 4)).setIconIndex(131);
	public static Item hoeGold = (new ItemHoe(38, 3)).setIconIndex(132);
	...
	public static Item shears = (new ItemShears(81)).setIconIndex(146);
