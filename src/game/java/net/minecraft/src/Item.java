...
public class Item {
	...
	public static Item rawIron = (new Item(77)).setIconIndex(56);
	public static Item rawGold = (new Item(78)).setIconIndex(57);
	public static Item rawCopper = (new Item(79)).setIconIndex(73);
