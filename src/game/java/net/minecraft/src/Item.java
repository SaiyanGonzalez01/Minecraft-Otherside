...
public class Item {
	...
	public static Item shovelSteel = (new ItemSpade(0, EnumToolMaterial.IRON)).setIconIndex(82);
	public static Item pickaxeSteel = (new ItemPickaxe(1, EnumToolMaterial.IRON)).setIconIndex(98);
	public static Item axeSteel = (new ItemAxe(2, EnumToolMaterial.IRON)).setIconIndex(114);
	...
	public static Item swordSteel = (new ItemSword(11, EnumToolMaterial.IRON)).setIconIndex(66);
	public static Item swordWood = (new ItemSword(12, EnumToolMaterial.WOOD)).setIconIndex(64);
	public static Item shovelWood = (new ItemSpade(13, EnumToolMaterial.WOOD)).setIconIndex(80);
	public static Item pickaxeWood = (new ItemPickaxe(14, EnumToolMaterial.WOOD)).setIconIndex(96);
	public static Item axeWood = (new ItemAxe(15, EnumToolMaterial.WOOD)).setIconIndex(112);
	public static Item swordStone = (new ItemSword(16, EnumToolMaterial.STONE)).setIconIndex(65);
	public static Item shovelStone = (new ItemSpade(17, EnumToolMaterial.STONE)).setIconIndex(81);
	public static Item pickaxeStone = (new ItemPickaxe(18, EnumToolMaterial.STONE)).setIconIndex(97);
	public static Item axeStone = (new ItemAxe(19, EnumToolMaterial.STONE)).setIconIndex(113);
	public static Item swordDiamond = (new ItemSword(20, EnumToolMaterial.EMERALD)).setIconIndex(67);
	public static Item shovelDiamond = (new ItemSpade(21, EnumToolMaterial.EMERALD)).setIconIndex(83);
	public static Item pickaxeDiamond = (new ItemPickaxe(22, EnumToolMaterial.EMERALD)).setIconIndex(99);
	public static Item axeDiamond = (new ItemAxe(23, EnumToolMaterial.EMERALD)).setIconIndex(115);
	...
	public static Item swordGold = (new ItemSword(27, EnumToolMaterial.GOLD)).setIconIndex(68);
	public static Item shovelGold = (new ItemSpade(28, EnumToolMaterial.GOLD)).setIconIndex(84);
	public static Item pickaxeGold = (new ItemPickaxe(29, EnumToolMaterial.GOLD)).setIconIndex(100);
	public static Item axeGold = (new ItemAxe(30, EnumToolMaterial.GOLD)).setIconIndex(116);
	...
	public static Item hoeWood = (new ItemHoe(34, EnumToolMaterial.WOOD)).setIconIndex(128);
	public static Item hoeStone = (new ItemHoe(35, EnumToolMaterial.STONE)).setIconIndex(129);
	public static Item hoeSteel = (new ItemHoe(36, EnumToolMaterial.IRON)).setIconIndex(130);
	public static Item hoeDiamond = (new ItemHoe(37, EnumToolMaterial.EMERALD)).setIconIndex(131);
	public static Item hoeGold = (new ItemHoe(38, EnumToolMaterial.GOLD)).setIconIndex(132);
