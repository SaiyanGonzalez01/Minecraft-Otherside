...
public class Block {
	...
	public static final Block oreGold = (new BlockOreGold(14, 32)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep);
	public static final Block oreIron = (new BlockOreIron(15, 33)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep);
	...
	public static final Block oreCopper = (new BlockOreCopper(68, 51)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep);
